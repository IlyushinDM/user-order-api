...
// 	"github.com/IlyushinDM/user-order-api/internal/repository/order_rep"   // Импортируем интерфейс репозитория заказа
// 	"github.com/IlyushinDM/user-order-api/internal/repository/user_rep"    // Импортируем интерфейс репозитория пользователя
...
// // MockOrderRepository - мок реализация интерфейса order_rep.OrderRepository.
...
// // MockUserRepository - мок реализация интерфейса user_rep.UserRepository.
...
// func setupService(orderRepo order_rep.OrderRepository, userRepo user_rep.UserRepository) order_service.OrderService {
