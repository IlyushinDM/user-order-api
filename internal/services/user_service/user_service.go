...
type UserService interface {
	...
	GetAllUsers(ctx context.Context, page, limit int, filters map[string]interface{}) ([]user_model.User, int64, error)
...
func NewUserService(repo user_db.UserRepository, log *logrus.Logger, jwtSecret string, jwtExp int) UserService {
...
func (s *userService) UpdateUser(
	ctx context.Context,
	id uint,
	req user_model.UpdateUserRequest) (*user_model.User, error) {
...
func (s *userService) GetAllUsers(
	...
	page,
	limit int,
	filters map[string]interface{}) ([]user_model.User, int64, error) {
