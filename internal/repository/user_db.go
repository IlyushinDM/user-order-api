...
type UserRepository interface {
	...
	GetAll(ctx context.Context, page, limit int, filters map[string]interface{}) ([]models.User, int64, error)
}
...
func (r *gormUserRepository) GetAll(ctx context.Context, page, limit int, filters map[string]interface{}) ([]models.User, int64, error) {
